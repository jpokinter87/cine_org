"""
Tests unitaires pour WorkflowService._auto_validate_series_episodes.

Vérifie que l'auto-validation des épisodes ne valide que les fichiers
ayant le même candidat TVDB dans leur liste de candidats.
"""
